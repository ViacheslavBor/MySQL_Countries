...
select count(cities.id) as num_cities, countries.name
from countries
...
order by countries.life_expectancy;
...
select count(countries.id) as contry, countries.region
from countries
group by(countries.region)
order by contry desc;